...
//            input = ResourceRetriever.getResourceAsStream(file);
            String convertedFileName = file.replace('\\', '/');
            input = new FileInputStream(convertedFileName);
            ...
            if (nBitCount == 24) {
                ...
                System.out.println("Not a 24-bit or 8-bit Windows Bitmap, aborting... nBitCount = " + nBitCount);
                image = null;
            }
        } finally {
            try {
